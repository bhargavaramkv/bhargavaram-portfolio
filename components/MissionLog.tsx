...
const ProjectCard: React.FC<{ project: Project }> = ({ project }) => (
  <div className="group relative bg-white border-4 border-black shadow-comic transition-all duration-300 hover:-translate-y-2 hover:shadow-[12px_12px_0px_0px_#0064FF] flex flex-col h-full">
    ...
    <section className="py-24 bg-gray-100">
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <h2 className="text-6xl font-comic text-gray-900">PROJECTS</h2>
        </div>
