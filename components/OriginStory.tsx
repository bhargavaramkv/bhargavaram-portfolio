    ...
    <section className="py-24 bg-slate-50 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-stretch mb-12">
          ...
          <div className="comic-panel bg-marvel-dark text-white p-6 relative mt-12 md:mt-0 transform -rotate-1 hover:rotate-0 transition-transform duration-300 border-white/20">
            ...
            <p className="font-body text-lg text-gray-300 leading-relaxed">
              My journey at <span className="font-bold text-jarvis-blue">ABB</span> pushed me into a new frontier where systems weren’t just built, they were engineered to endure. I dove into distributed architecture, shaping high-velocity services powered by <span className="font-bold text-white">.NET Core</span> and <span className="font-bold text-white">MongoDB</span>. Every line of code had a single purpose: sustain performance when the planet comes calling. In that pressure, I found my rhythm. Scalability wasn’t just a requirement, it became the way I think.
            </p>
          </div>
        ...
        <div className="relative max-w-4xl mx-auto mt-16">
          <div className="bg-white border-4 border-black p-8 shadow-[12px_12px_0px_0px_#0064FF] relative overflow-hidden group hover:shadow-[8px_8px_0px_0px_#F0DE36] transition-all">
            ...
            <div className="flex flex-col md:flex-row items-center gap-8 relative z-10">
              {/* Icon / Seal */}
              <div className="w-24 h-24 bg-marvel-yellow rounded-full flex items-center justify-center border-4 border-black shadow-md shrink-0 animate-[pulse_3s_infinite]">
